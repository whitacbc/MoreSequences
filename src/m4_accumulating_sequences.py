...
def rectangles_from_circles(circles):
    ...
    rectange_list=[]
    for i in circles:
        rec_point1 = rg.Point(i.center.x - i.radius,i.center.y-i.radius)
        rec_point2 = rg.Point(i.center.x + i.radius,i.center.y+i.radius)
        pulled_rectangle= rg.Rectangle(rec_point1,rec_point2)
        rectange_list.append(pulled_rectangle)
